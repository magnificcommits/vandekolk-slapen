          ...
          <div className="grid gap-12 lg:grid-cols-12">
            <aside className="lg:col-span-4">
              ...
              <p className="mt-6 leading-relaxed text-ink-soft">
                De showroom is van u. Geen andere klanten aan uw bed, geen tijdsdruk. Martin of Robert neemt de tijd, meet met de Sleep Scan en laat u drie tot vier bedden proberen die echt bij u passen.
              </p>
              <ul className="mt-8 space-y-4 text-sm">
                {[
                  "Sleep Scan van Equilli inbegrepen (t.w.v. € 49)",
                  "Ook op dinsdag- en donderdagavond en op maandag",
                  "Advies aan huis binnen 45 km van Lochem",
                  "Parkeren direct achter de winkel",
                ].map((t) => (

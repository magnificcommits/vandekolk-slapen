...
export default function Page() {
  const groups: { title: string; text: string; tier: string }[] = [
    { tier: "signature", title: "Signature", text: "Met de hand gemaakt, natuurlijk, voor een leven lang. Nergens anders in Oost-Nederland naast elkaar te proberen." },
    { tier: "premium", title: "Premium", text: "Nederlandse en Scandinavische topmerken. Eerlijk geprijsd, in bijna elke maat en stof te krijgen." },
    { tier: "care", title: "Zorg en comfort", text: "Zorgbedden die eruitzien als een gewoon bed. Zo woont u langer thuis." },
  ];
      ...
      <div className="pt-24 lg:pt-32">
        <Section className="!pb-8">
          <div className="max-w-3xl">
            ...
            <Heading as="h1" className="mt-4">Acht merken. Niet veertig.</Heading>
            <p className="mt-6 text-lg leading-relaxed text-ink-soft">
              Wij verkopen alleen wat we zelf zouden kopen. Elk merk heeft een eigen manier van bouwen, een eigen liggevoel en een eigen prijs. Welk merk bij u past, merkt u bij het proefliggen.
            </p>
            <p className="mt-4 text-sm text-stone">De prijzen zijn een indicatie voor een compleet tweepersoonsbed van 180 x 200 cm, met matrassen en hoofdbord. De precieze prijs hangt af van uitvoering, maat en stof.</p>
          </div>
        </Section>

        {groups.map((g) => (
          <Section key={g.tier} className="!pt-4 !pb-10">
        ...
        <Section>
          <div className="grid gap-10 lg:grid-cols-12">
            <div className="lg:col-span-5">
              ...
              <Heading className="mt-4">Wat op het bed ligt, telt ook mee.</Heading>
              <p className="mt-5 leading-relaxed text-ink-soft">Dekbedden, kussens en lakens van twee merken die net zo over kwaliteit denken als wij.</p>
            </div>
